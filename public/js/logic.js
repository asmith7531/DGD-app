$(document).ready(function() {
  ...
  $(".overpack").click(function overpack() {
    ...
    console.log(overpackDims.overpack4x1.small);
    var newtr = $("<tr>");
        ...
        case "4x4":
          while (boxTotals[i] > 0) {
            if (boxTotals[i] >= overpackDims.overpack4x4.large) {
              ...
              overpackDims.overpack4x4.small <
              boxTotals[i] <=
              overpackDims.overpack4x4.medium
            ) {
              overpackList.medium += 1;
        ...
        case "2x10":
          while (boxTotals[i] > 0) {
            if (boxTotals[i] >= overpackDims.overpack2x10.large) {
              ...
              overpackDims.overpack2x10.small <
              boxTotals[i] <=
              overpackDims.overpack2x10.medium
            ) {
              overpackList.medium += 1;
        ...
        case "6x1":
          while (boxTotals[i] > 0) {
            if (boxTotals[i] >= overpackDims.overpack6x1.large) {
              ...
              overpackDims.overpack6x1.small <
              boxTotals[i] <=
              overpackDims.overpack6x1.medium
            ) {
              overpackList.medium += 1;
              boxTotals[i] = boxTotals[i] - overpackDims.overpack6x1.medium;
            } else if (4 < boxTotals[i] <= overpackDims.overpack6x1.small) {
              //<-----------//////////////////////////////////////////// ADD THE MIN OF 6x1
